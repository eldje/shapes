...
namespace A01_winform
{
    public partial class MainPage : Form
    {
        ...
        {
            InitializeComponent();
            this.Text = "ShapeMaker: Makes your shapes ;-)";
            cmbSelectShape.DropDownStyle = ComboBoxStyle.DropDownList;
        ...
        protected void SetObject()
        {
            ...
            lblStatus.Text = "Shape " + txtbName.Text + " was added.";
        ...
        private void btnDeleteGreenShape_Click(object sender, EventArgs e)
        {
            ...
            {
                foreach (Shape shape in lstGreen.SelectedIndices)
                {
                    shapeRepository.Shapes.Remove(shape);
                }
                refreshForm();
                updateLables();
            }
        ...
        private void btnDeleteOrangeShape_Click(object sender, EventArgs e)
        {
            ...
            {
                foreach (Shape o in shapeRepository.Shapes)
                {
                    if (o.Equals(lstOrange.SelectedItem))
                        shapeRepository.Shapes.Remove(o);
                }
                lstOrange.Items.Remove(lstOrange.SelectedIndices);
                refreshForm();
                updateLables();
            }
        }
        ...
        private void btnDeleteRedShape_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                foreach (Shape o in shapeRepository.Shapes)
                {
                    if (o.Equals(lstRed.SelectedItem))
                        shapeRepository.Shapes.Remove(o);
                }
                lstRed.Items.Remove(lstRed.SelectedIndices);
                refreshForm();
                updateLables();
            }
        }
